                ...
                <form action="../logic/edit-pinjam.php" method="post">
                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <td><input type="datetime-local" name="" id="" value="<?php echo $data['tanggal_pinjam'];?>" readonly></td>
                            </tr>
                            <tr>
                                <td>Rencana Pengembalian</td>
                                <td><input type="datetime-local" name="" id="" value="<?php echo $data['rencana_pengembalian'];?>" readonly></td>
                            </tr>
                            <tr>
                                <td>Tanggal Pengembalian</td>
                                <td><input type="datetime-local" name="" id="" value="<?php echo $data['tanggal_pengembalian'];?>" readonly></td>
                            </tr>
                            <tr>
                                <td>Peruntukan</td>
                                <td>
                                    <textarea name="peruntukan" id="" cols="21" rows="3">
                            ...
                            <tr>
                                <td colspan="2"><input type="submit" value="Simpan Perubahan" name="submit"></td>
                            </tr>
                    <?php } ?>
                </form>
            </table>
